...
export default function WhatsAppButton() {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-8 right-8 z-40 flex items-center gap-3 bg-[#25D366] text-white pl-4 pr-5 py-3.5 shadow-lg shadow-[#25D366]/30 group transition-all duration-300"
    >
      <svg
